...
const faqs = [{"q":"¿Cómo cuento palabras en español gratis?","a":"Usa el Contador de Palabras en Español de WordCounterTool.net. Es gratuito, no requiere registro, y funciona directamente en tu navegador. Pega tu texto y obtendrás al instante el número de palabras, caracteres, oraciones y tiempo de lectura."},{"q":"¿Un texto en español tiene más palabras que en inglés?","a":"Sí, aproximadamente un 15-25% más. Esto se debe a que el español usa más artículos, preposiciones y construcciones verbales compuestas. Un texto de 1000 palabras en inglés equivale a unas 1150-1250 palabras en español."},{"q":"¿Cuántas palabras por minuto lee un hispanohablante?","a":"El promedio para lectores nativos adultos es de 200-250 palabras por minuto en textos generales. En textos técnicos o académicos la velocidad baja a 150-180 wpm. Los lectores rápidos pueden alcanzar 400+ wpm con práctica."},{"q":"¿Los signos ¿ y ¡ cuentan como caracteres?","a":"Sí, los signos de apertura ¿ y ¡ cuentan cada uno como un carácter en todas las plataformas, incluyendo Twitter/X, Instagram y LinkedIn. Sin embargo, no cuentan como palabras separadas."},{"q":"¿La ñ y las tildes afectan el conteo de caracteres?","a":"En la mayoría de plataformas y herramientas modernas, la ñ, las tildes (á, é, í, ó, ú) y la diéresis (ü) cuentan como un solo carácter cada una, igual que cualquier letra del alfabeto inglés."},{"q":"¿Cuántas palabras debe tener un artículo SEO en español?","a":"Los artículos que aparecen en la primera página de Google en español promedian 1500-2500 palabras. Para nichos competitivos, apunta a 2500-3500 palabras. La clave es cubrir el tema a fondo sin rellenar con contenido innecesario."}]

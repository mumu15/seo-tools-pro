      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div className="my-8 rounded-xl overflow-hidden border border-slate-800">
            <img src="/images/blog/how-to-write-blog-introduction.svg" alt="How To Write Blog Introduction — key data" width={680} height={450} className="w-full h-auto" loading="lazy" />
          </div>

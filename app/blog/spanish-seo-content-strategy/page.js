  ...
  return (
    <>
        ...
        <article>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <text x="4" y="62" fill="#94a3b8" style={{fontSize:'12px'}}>Inglés</text>
      ...
      <text x="261.2" y="134" fill="#34d399" style={{fontSize:'12px',fontWeight:'600'}}>420M</text>
              <text x="4" y="170" fill="#94a3b8" style={{fontSize:'12px'}}>Árabe</text>
      <rect x="160" y="152" width="63.46666666666667" height="28" rx="4" fill="rgba(52,211,153,0.25)" />
      <text x="229.46666666666667" y="170" fill="#34d399" style={{fontSize:'12px',fontWeight:'600'}}>280M</text>
              <text x="4" y="206" fill="#94a3b8" style={{fontSize:'12px'}}>Portugués</text>

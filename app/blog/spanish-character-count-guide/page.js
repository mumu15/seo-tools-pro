...
const faqs = [{"q":"¿La ñ cuenta como un carácter o como dos?","a":"La ñ cuenta como un solo carácter en todas las plataformas modernas (Twitter, Instagram, Google Ads, etc.). Esto incluye las vocales acentuadas (á, é, í, ó, ú) y la diéresis (ü). Todas ocupan un solo punto de código Unicode."},{"q":"¿Cuántos caracteres tiene un tuit en español?","a":"El límite de Twitter/X es de 280 caracteres para cuentas estándar y 25.000 para cuentas premium. Los signos de apertura ¿ y ¡ cuentan como un carácter cada uno. Para máximo engagement en español, apunta a 200-240 caracteres."},{"q":"¿Cómo afectan las tildes al SEO?","a":"Las tildes no afectan negativamente al SEO. Google entiende que \\"información\\" e \\"informacion\\" se refieren a lo mismo. Sin embargo, en las URLs es mejor evitar tildes para mantener URLs limpias y compartibles."},{"q":"¿Cuántos caracteres debo usar en un meta title en español?","a":"Máximo 55-60 caracteres para evitar que Google trunque tu título en los resultados de búsqueda. Coloca la palabra clave principal en los primeros 30 caracteres."},{"q":"¿Los emojis cuentan como caracteres en español?","a":"Sí, la mayoría de emojis cuentan como 2 caracteres en Twitter/X. En otras plataformas como Instagram y Facebook, cuentan como 1 carácter visible pero pueden ocupar más bytes internamente."},{"q":"¿Cuántos caracteres tiene la meta description ideal?","a":"Entre 145 y 155 caracteres en español. Google muestra hasta aproximadamente 160 caracteres, pero como el español usa más caracteres que el inglés, es mejor quedarse en 150 para asegurar que se muestre completa."}]

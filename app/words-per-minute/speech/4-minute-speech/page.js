...
export const metadata = {
  title: 'How Many Words in a 4 Minute Speech? (2026) | WordCounterTool.net',
  description: 'A 4 minute speech is 520-600 words at average speaking pace. See word counts for slow, average and fast speakers. Free speech word counter.',
  alternates: { canonical: 'https://www.wordcountertool.net/words-per-minute/speech/4-minute-speech' },
}

const faqs = [
  { q: 'How many words is a 4 minute speech?', a: 'A 4-minute speech is approximately 520-600 words at the average speaking rate of 130 words per minute. Slower speakers (100 wpm) need about 400 words, while faster speakers (160 wpm) need about 640 words.' },
  { q: 'How many pages is a 4 minute speech?', a: 'A 4-minute speech (520-600 words) is approximately 2-3 pages double-spaced or 1-1 pages single-spaced in 12pt Times New Roman font.' },
  { q: 'How do I time my speech to exactly 4 minutes?', a: 'Write your speech aiming for 520 words. Practice reading it aloud with a timer at least 3 times. Most people speak faster when nervous, so aim for slightly fewer words than the maximum. Leave 10-15% buffer for pauses and audience reactions.' },
]
...
export default function Page() {
  return (
    <>
      ...
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">4-Minute Speech</span>
          </nav>

          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">How Many Words in a 4-Minute Speech?</h1>

          <div className="bg-slate-800/40 border border-emerald-500/20 rounded-2xl p-6 mb-10">
            <p className="text-emerald-400 text-xs font-bold uppercase tracking-widest mb-2">Quick Answer</p>
            <p className="text-white text-lg leading-relaxed">A 4-minute speech is approximately 520-600 words at the average speaking rate of 130 words per minute. At a slower pace (100 wpm), aim for 400 words. At a faster pace (160 wpm), you need about 640 words. This length is common for a maid of honor speech, quick business update, or classroom presentation.</p>
          </div>

          <section className="mb-10">
            <h2 className="text-2xl font-bold text-white mb-4">4-Minute Speech Word Count by Speed</h2>
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6 overflow-x-auto">
              <table className="w-full text-sm">
                <thead><tr className="border-b" style={{borderColor:'rgba(52,211,153,0.2)'}}><th className="text-left text-emerald-400 py-3 pr-4 font-semibold text-xs uppercase">Speaking Speed</th><th className="text-left text-emerald-400 py-3 pr-4 font-semibold text-xs uppercase">Words Per Minute</th><th className="text-left text-emerald-400 py-3 font-semibold text-xs uppercase">Words in 4 Min</th></tr></thead>
                <tbody>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}><td className="text-white font-medium py-3 pr-4">Slow (deliberate)</td><td className="text-slate-300 py-3 pr-4">100 wpm</td><td className="text-slate-300 py-3">400 words</td></tr>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}><td className="text-white font-medium py-3 pr-4">Average (conversational)</td><td className="text-slate-300 py-3 pr-4">130 wpm</td><td className="text-slate-300 py-3">520 words</td></tr>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}><td className="text-white font-medium py-3 pr-4">Fast (energetic)</td><td className="text-slate-300 py-3 pr-4">160 wpm</td><td className="text-slate-300 py-3">640 words</td></tr>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}><td className="text-white font-medium py-3 pr-4">Very Fast</td><td className="text-slate-300 py-3 pr-4">200 wpm</td><td className="text-slate-300 py-3">800 words</td></tr>
                </tbody>
              </table>
            </div>
          </section>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-white mb-4">How to Write a 4-Minute Speech</h2>
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6">
              <p className="text-slate-300 text-sm leading-relaxed mb-4">A 4-minute speech requires approximately <strong className="text-emerald-400">520-600 words</strong>. The exact count depends on your natural speaking pace, pauses for emphasis, and audience interaction. Most speakers average 130 words per minute in a prepared speech setting.</p>
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-4"><strong className="text-white">Structure suggestion:</strong> Keep it simple with one main point, a brief intro, and a memorable closing. Every word counts at this length.</p>
              <p className="text-slate-300 text-sm leading-relaxed">Common uses for a 4-minute speech: a maid of honor speech, quick business update, or classroom presentation. Use our <a href="/word-counter" className="text-emerald-400 hover:underline">free word counter</a> to check your speech length before practicing.</p>
            </div>
          </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.wordcountertool.net"},{"@type":"ListItem","position":2,"name":"Words Per Minute","item":"https://www.wordcountertool.net/words-per-minute"},{"@type":"ListItem","position":3,"name":"4-Minute Speech","item":"https://www.wordcountertool.net/words-per-minute/speech/4-minute-speech"}]})}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"4-Minute Speech Word Counter","applicationCategory":"UtilityApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}})}} />
      <Footer />
    </>
  )
}

...
export const metadata = {
  title: 'How Many Words in a 20 Minute Speech? (2026) | WordCounterTool.net',
  description: 'A 20 minute speech is 2,600-3,000 words at average speaking pace. See word counts for slow, average and fast speakers. Free speech word counter.',
  alternates: { canonical: 'https://www.wordcountertool.net/words-per-minute/speech/20-minute-speech' },
};
...
export default function Page() {
  return (
    <>
      ...
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">Words in a 20 Minute Speech</span>
          </nav>

          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">How Many Words in a 20-Minute Speech?</h1>

          <div className="bg-slate-800/40 border border-emerald-500/20 rounded-2xl p-6 mb-10">
            <p className="text-emerald-400 text-xs font-bold uppercase tracking-widest mb-2">Quick Answer</p>
            <p className="text-white text-lg leading-relaxed">A 20-minute speech is approximately 2,600-3,000 words at the average speaking rate of 130 words per minute. At a slower pace (100 wpm), it is about 2 000 words. At a faster pace (160 wpm), it is about 3 200 words. This is roughly equivalent to a full lecture, detailed keynote, or workshop segment.</p>
          </div>

          <section className="mb-10">
            <h2 className="text-2xl font-bold text-white mb-4">20-Minute Speech Word Count by Speed</h2>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.2)'}}>
                    ...
                    <th className="text-left text-emerald-400 py-3 pr-4 font-semibold">Words in 20 Min</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}>
                    ...
                    <td className="text-slate-300 py-3 pr-4">2 600 words</td>
                  </tr>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}>
          ...
          <div className="bg-gradient-to-r from-emerald-900/30 to-teal-900/20 border border-emerald-500/30 rounded-2xl p-6 mb-10 text-center">
            <p className="text-white font-semibold text-lg mb-2">Check Your 20-Minute Speech Word Count</p>
          ...
          <section className="mb-10">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">How to Write a 20-Minute Speech</h2>
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6">
              <p className="text-slate-300 text-sm leading-relaxed mb-4">A 20-minute speech requires approximately <strong className="text-emerald-400">2,600-3,000 words</strong>. The exact count depends on your natural speaking pace, pauses for emphasis, and audience interaction. Most speakers average 130 words per minute in a prepared speech setting.</p>
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-4"><strong className="text-white">Structure suggestion for 20 minutes:</strong> Open with a story or surprising statistic, develop 3-4 main points with evidence and examples, include transitions between sections, and close with a powerful summary and call to action.</p>
              <p className="text-slate-300 text-sm leading-relaxed"><strong className="text-white">Common 20-minute speeches:</strong> This length is typical for a full lecture, detailed keynote, or workshop segment. Use our <a href="/word-counter" className="text-emerald-400 hover:underline">free word counter</a> to check your speech length before practicing.</p>
            </div>
          </section>
          <section className="mb-10">
            ...
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6">
              <div className="space-y-4 text-sm">
                <div className="border-b pb-4" style={{borderColor:"rgba(52,211,153,0.1)"}}>
                  <h3 className="text-white font-semibold mb-2">How many words is a 20 minute speech?</h3>
                  <p className="text-slate-400">A 20-minute speech is approximately 2,600-3,000 words at the average speaking rate of 130 words per minute. Slower speakers (100 wpm) need about 2 000 words, while faster speakers (160 wpm) need about 3 200 words.</p>
                </div>
                <div className="border-b pb-4" style={{borderColor:"rgba(52,211,153,0.1)"}}>
                  <h3 className="text-white font-semibold mb-2">How many pages is a 20 minute speech?</h3>
                  <p className="text-slate-400">A 20-minute speech (2,600-3,000 words) is approximately 10-13 pages double-spaced or 5-7 pages single-spaced in 12pt Times New Roman font.</p>
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-2">How do I make my speech exactly 20 minutes?</h3>
                  <p className="text-slate-400">Write your speech, then use our word counter to check the count. Aim for 2600 words. Practice reading it aloud with a timer 3 times. Adjust by cutting or adding content until you consistently hit 20 minutes. Remember to account for pauses and audience reactions.</p>
                </div>
              </div>
            </div>
          </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.wordcountertool.net"},{"@type":"ListItem","position":2,"name":"Words in a 20 Minute Speech","item":"https://www.wordcountertool.net/words-per-minute/speech/20-minute-speech"}]})}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"Words in a 20 Minute Speech","applicationCategory":"UtilityApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}})}} />

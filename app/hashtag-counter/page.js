...
export default function HashtagCounter() {
  ...
  return (
    <>
      <FaqSchema faqs={faqs} />
      <BreadcrumbSchema items={[{"name":"Home","url":"https://www.wordcountertool.net"},{"name":"Free Hashtag Counter — Instagram, Twitter, TikTok","url":"https://www.wordcountertool.net/hashtag-counter"}]} />
      <WebAppSchema name="Hashtag Counter" description="Count hashtags and check platform limits for Instagram, Twitter, TikTok and LinkedIn — free tool. Free hashtag counter with platform limits." url="https://www.wordcountertool.net/hashtag-counter" />
      <Header />
        ...
        <div className="space-y-6 mt-12">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <a href="/twitter-thread-counter" className="result-box group hover:-translate-y-1 transition-all duration-300 hover:border-emerald-500/30">
                <div className="text-3xl mb-3">🧵</div>
                <h3 className="text-white font-bold text-sm mb-1 group-hover:text-emerald-400 transition-colors">Twitter Thread Counter</h3>
                <p className="text-slate-500 text-xs leading-relaxed">Plan your Twitter threads</p>
              </a>
              ...
              <a href="/meta-tag-generator" className="result-box group hover:-translate-y-1 transition-all duration-300 hover:border-emerald-500/30">
                <div className="text-3xl mb-3">🏷️</div>
                <h3 className="text-white font-bold text-sm mb-1 group-hover:text-emerald-400 transition-colors">Meta Tag Generator</h3>
                <p className="text-slate-500 text-xs leading-relaxed">Generate perfect SEO meta tags</p>
              </a>
            </div>
          </div>
      </main>

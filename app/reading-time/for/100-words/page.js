...
export const metadata = {
  title: 'How Long Does It Take to Read 100 Words? | WordCounterTool.net',
  description: 'Find out exactly how long it takes to read 100 words at average, fast and slow reading speeds. Plus tips on reading time for different content types.',
  alternates: { canonical: 'https://www.wordcountertool.net/reading-time/for/100-words' },
};
      ...
      <main className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <nav className="text-sm text-slate-500 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-slate-300">100 Words</span>
          </nav>

          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">How Long Does It Take to Read 100 Words?</h1>
          <p className="text-slate-400 text-lg mb-10">Reading time for 100 words depends on your reading speed. Here are the exact times at slow, average and fast reading speeds.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            <div className="bg-slate-800/50 border border-emerald-500/30 rounded-2xl p-6 text-center">
              ...
              <p className="text-white text-3xl font-bold mb-1">0 minutes</p>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 text-center">
              ...
              <p className="text-white text-3xl font-bold mb-1">37 seconds</p>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 text-center">
              ...
              <p className="text-white text-3xl font-bold mb-1">50 seconds</p>
          ...
          <div className="bg-slate-800/40 border border-emerald-500/20 rounded-2xl p-6 mb-10">
            ...
            <p className="text-white text-lg">It takes approximately <strong>0 minutes</strong> to read 100 words at the average reading speed of 250 words per minute. At a fast reading speed of 400 WPM it takes 37 seconds. At a slow reading speed of 150 WPM it takes 50 seconds.</p>
          </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.2)'}}>
                    ...
                    <th className="text-left text-emerald-400 py-3 pr-4 font-semibold">Time for 100 Words</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}>
                    ...
                    <td className="text-slate-300 py-3 pr-4">50 seconds</td>
                  </tr>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}>
                  ...
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}>
                    ...
                    <td className="text-slate-300 py-3 pr-4">37 seconds</td>
                  </tr>
                  <tr className="border-b" style={{borderColor:'rgba(52,211,153,0.05)'}}>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-white mb-4">What Can You Read in 100 Words?</h2>
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6">
              <p className="text-slate-300 leading-relaxed mb-4">100 words is roughly the length of a short social media post or a paragraph in a news article. Use the reading time calculator to check any piece of content instantly.</p>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              <div className="border border-slate-700/50 rounded-xl p-5">
                <h3 className="text-white font-semibold mb-2">How long does it take to read 100 words out loud?</h3>
                <p className="text-slate-400 text-sm leading-relaxed">Reading aloud is slower than silent reading. The average speaking pace is 130 to 150 words per minute. At 140 WPM, 100 words takes approximately 1 minutes to read aloud. This is useful for speeches, podcasts and audiobook estimates.</p>
              </div>
              <div className="border border-slate-700/50 rounded-xl p-5">
                <h3 className="text-white font-semibold mb-2">How many pages is 100 words?</h3>
                <p className="text-slate-400 text-sm leading-relaxed">In a standard document with Times New Roman 12pt double spacing, 100 words is approximately 0 pages. Single spaced it is about 0 pages. Published books average 250 to 300 words per page.</p>
              </div>
              <div className="border border-slate-700/50 rounded-xl p-5">
              ...
              <div className="border border-slate-700/50 rounded-xl p-5">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">Divide your word count by 250 to get the reading time in minutes at average speed. For example, 100 divided by 250 equals 0.4 minutes. Use our free reading time calculator to get instant results for any text.</p>
              </div>
            </div>
          </section>

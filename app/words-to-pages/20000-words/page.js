    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"20 000 Words to Pages","applicationCategory":"UtilityApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}})}} />
        ...
        <div className="max-w-4xl mx-auto mt-14 px-4 space-y-10">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>What Is 20 000 Words?</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>20,000 words fills 80 double-spaced pages. This is a substantial thesis, a full ebook, a novella, or a comprehensive technical manual.</p>
            <p className="leading-relaxed" style={{color:'#94a3b8'}}>At 20,000 words you are writing a book-length document. This requires chapter-level planning, consistent voice across days or weeks of writing, and professional editing. Few people can write 20,000 quality words in less than a month.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>Writing 20 000 Words: Structure and Strategy</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Use a chapter outline with target word counts for each chapter. Aim for 5-8 chapters of 2,500-4,000 words each. Build in time for revision — a 20,000-word document needs at least two full editing passes.</p>
            <p className="leading-relaxed" style={{color:'#94a3b8'}}>Reading time: about 84 minutes. This is a book you read over several sessions. Provide clear stopping points at the end of each chapter so readers can put it down and pick it up again easily.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>Real-World Examples of 20 000-Word Documents</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>A standard ebook for marketing purposes is 15,000-25,000 words. A novella is 17,500-40,000 words. An undergraduate thesis is 10,000-20,000 words. A detailed company handbook might run 20,000-30,000 words.</p>
            <p className="leading-relaxed" style={{color:'#94a3b8'}}>Tonal inconsistency becomes a serious problem at 20,000 words. If you write chapter 1 on Monday and chapter 7 two weeks later, they may read like different authors wrote them. Do a dedicated voice-consistency pass after completing the first draft.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>20 000 Words in Different Formats</h2>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                    ...
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>84 min read</td>
                  </tr>
                  <tr style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                    <td className="py-2.5 px-4 font-medium" style={{color:'#f1f5f9'}}>1.5 spaced</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>53.3 pages</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>84 min read</td>
                  </tr>
                  <tr style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                    <td className="py-2.5 px-4 font-medium" style={{color:'#f1f5f9'}}>Double spaced (standard academic)</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>80.0 pages</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>84 min read</td>
                  </tr>
                  <tr style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                    ...
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>154 min speaking</td>
                  </tr>
                  <tr style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                    <td className="py-2.5 px-4 font-medium" style={{color:'#f1f5f9'}}>Speech at 150 WPM (conversational)</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>N/A</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>133 min speaking</td>
                  </tr>
                  <tr style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                    <td className="py-2.5 px-4 font-medium" style={{color:'#f1f5f9'}}>Handwritten</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>114.3 pages</td>
                    <td className="py-2.5 px-4" style={{color:'#94a3b8'}}>84 min read</td>
                  </tr>
                </tbody>
              </table>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>How Long Does It Take to Write 20 000 Words?</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>At an average typing speed of 40 words per minute, the raw typing time for 20 000 words is about 500 minutes. But typing is not writing. Research, outlining, drafting, and editing bring the total time to roughly 40.0 hours for polished content.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Professional copywriters typically produce 1,000-2,000 polished words per day. Academic writers average 500-1,000 new words per day. At those rates, a 20 000-word piece takes 2-6 weeks of focused work.</p>
            <p className="leading-relaxed" style={{color:'#94a3b8'}}>AI writing tools can generate 20 000 words in seconds, but the output requires substantial editing for accuracy, voice, and originality. Most content marketers in 2026 use AI for first drafts and outlines, then spend the bulk of their time revising. The editing phase typically takes as long as the drafting phase, regardless of whether AI was involved.</p>
          </section>

export default function sitemap() {
  ...
  const staticPages = ["/","/word-counter","/character-counter","/keyword-density","/meta-tag-generator","/readability-checker","/sentence-counter","/reading-time","/words-per-minute","/words-per-page","/twitter-thread-counter","/about","/contact","/privacy-policy","/blog"];

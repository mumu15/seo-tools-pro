    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"Character Limits Guide","applicationCategory":"UtilityApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}})}} />
        ...
        <div className="max-w-4xl mx-auto mt-14 px-4 space-y-10">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>TikTok Character Limits in 2026</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>TikTok expanded captions to 4,000 characters in 2024-2025, up from the original 300. This was not about encouraging long captions — it was about enabling TikTok\'s internal search engine. Longer captions give the algorithm more text to index and categorize.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Despite the 4,000-character allowance, the visual interface hides most of the caption. Only the first 80-100 characters appear below the video. Users must tap to expand. This means your first line is your hook, and everything after it is bonus context for search and the algorithm.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Bio: 80 characters. Username: 24 characters. Comments: 150 characters. Video description (during upload): 4,000 characters. These limits apply across iOS, Android, and the web uploader.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>TikTok Caption Strategy for 2026</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Put your primary keyword in the first 80 characters. TikTok\'s search algorithm weights the beginning of captions more heavily than the end. If your video is about meal prep, "5 meal prep ideas that take 15 minutes" should appear first, not buried after three hashtags.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Hashtags on TikTok still matter for discovery, but the platform increasingly relies on video content analysis (what is shown and said in the video) over caption text. Use 3-5 relevant hashtags. Skip generic ones like #fyp and #viral — they do not improve reach and waste characters.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>The 4,000-character limit is useful for SEO-style descriptions on educational or tutorial content. Think of the expanded caption as a mini blog post that helps TikTok understand and categorize your video. Viewers may not read it all, but the algorithm does.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>TikTok Video Length vs. Caption Length</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Video length has expanded to 10 minutes, but 15-60 second videos still dominate the platform. The 7-second video challenge showed that extremely short content can go massively viral with the right hook.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>For TikTok ads, the recommended video length is 21-34 seconds. Paired with a caption under 100 characters. The ad caption should provide context the video does not — like a price, a CTA, or a landing page description.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Longer videos (3-10 minutes) are growing in popularity for educational and storytelling content. These benefit from longer captions that outline what the video covers, helping both the algorithm and viewers decide whether to watch.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'#f1f5f9'}}>TikTok Bio: 80 Characters That Matter</h2>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Your TikTok bio gets 80 characters. That is roughly 12-15 words. It needs to communicate your niche and personality. "Cooking for people who hate cooking" (38 characters) is a perfect TikTok bio. It is specific, it has a point of view, and it tells you exactly what to expect.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Include a CTA if you have a link. "Free recipes ↓" or "New video every Tuesday" gives viewers a reason to follow or tap the link in your bio. Emojis can replace words to save characters: "📍NYC" instead of "Based in New York City" saves 18 characters.</p>
            <p className="leading-relaxed mb-3" style={{color:'#94a3b8'}}>Do not waste bio characters on your name (it is already displayed above the bio) or generic phrases like "Content creator." Everyone on TikTok is a content creator. Say what kind.</p>
          </section>

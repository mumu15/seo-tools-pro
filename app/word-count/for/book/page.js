    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"Word Count Guide","applicationCategory":"UtilityApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}})}} />
        ...
        <div className="max-w-4xl mx-auto mt-14 px-4 space-y-10">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Word Count Expectations by Genre</h2>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Literary agents have shared specific word count windows that they consider when reviewing queries. A literary agent posted on X that middle-grade contemporary fiction should fall between 30,000-60,000 words, middle-grade SFF 50,000-70,000, YA contemporary 50,000-80,000, YA SFF 70,000-100,000, adult fiction 70,000-120,000, and adult SFF 100,000-150,000.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>These ranges exist for practical reasons. A 40,000-word adult novel would be priced like a full novel but feel thin — readers would feel shortchanged. A 200,000-word debut would cost significantly more to print, ship, and shelve, making it a financial risk for the publisher.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Genres have different norms because their readers have different expectations. Romance readers expect 60,000-80,000 words and a fast pace. Epic fantasy readers expect 100,000-150,000 words and detailed worldbuilding. Thriller readers want 70,000-90,000 words of tight plotting. Matching your genre\'s expected length is one of the first signals to an agent that you understand your market.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Famous Books and Their Word Counts</h2>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>The Great Gatsby: 47,094 words. Animal Farm: 29,966 words. To Kill a Mockingbird: 100,388 words. Harry Potter and the Philosopher\'s Stone: 77,325 words. Harry Potter and the Order of the Phoenix: 257,045 words. The entire Lord of the Rings trilogy: 576,459 words.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>These numbers show that "how long should a book be" has no single answer. Some of the most celebrated novels in history are under 50,000 words. Some bestsellers exceed 250,000. What matters is whether every word earns its place.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>For first-time authors, agents typically recommend 70,000-90,000 words for literary fiction and 80,000-100,000 for genre fiction. Debut novels that run much longer are harder to sell because publishers are taking a financial risk on an unknown author. Once you have a track record, you earn the right to write 150,000-word books.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>The Writing Process: Daily Word Count Targets</h2>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Stephen King writes 2,000 words a day, six days a week. That pace produces a 90,000-word first draft in about 7-8 weeks. Most authors cannot sustain that pace, and that is fine.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>NaNoWriMo (National Novel Writing Month) sets a target of 50,000 words in 30 days — 1,667 words per day. About 20% of participants "win" by hitting 50,000. The exercise proves that a novel-length manuscript can be drafted in a month with daily discipline, even if the resulting draft needs heavy revision.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>A more sustainable pace for most writers is 500-1,000 words per day, 5 days a week. At 750 words per day, a 75,000-word novel takes about 20 weeks to draft. Add 4-8 weeks for revision, and you are looking at a 6-8 month timeline for a completed manuscript. Professional authors often work on 1-2 books per year at this pace.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Self-Publishing vs. Traditional: Does Length Matter?</h2>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>In traditional publishing, word count matters because it directly affects production costs. A 120,000-word book costs more to print than a 70,000-word book. Publishers factor this into their advance offers and pricing decisions.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>In self-publishing, word count matters less financially but still matters for reader expectations. Kindle readers, in particular, have strong genre expectations. A self-published romance at 30,000 words will get negative reviews for being "too short." A self-published thriller at 150,000 words will get complaints about pacing.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Kindle Unlimited pays by pages read, which means longer books can earn more per borrow — but only if readers finish them. A 100,000-word book that 80% of readers abandon at the halfway point earns less than a 60,000-word book that 90% of readers finish. Length without engagement is not a monetization strategy.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Children\'s Books: A Different Scale</h2>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Picture books: 500-1,000 words. Many successful picture books are under 500. "Goodnight Moon" is 130 words. The constraint is not just word count but page count — picture books are typically 32 pages, and the text must leave room for illustrations.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Early readers (ages 5-7): 1,000-5,000 words with short sentences and simple vocabulary. Chapter books (ages 7-10): 5,000-15,000 words. Middle grade (ages 8-12): 30,000-60,000 words.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Writing shorter is harder. A 500-word picture book that tells a complete, satisfying story with emotional resonance is one of the most difficult things to write well. Every word carries ten times the weight it would in a novel.</p>
          </section>

    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"Op Ed Word Count","applicationCategory":"UtilityApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}})}} />
        ...
        <div className="max-w-4xl mx-auto mt-14 px-4 space-y-10">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Why Op Ed Length Matters</h2>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Every document type has an expected length range. Fall significantly short and the reader assumes you did not put in the work. Go significantly over and they assume you cannot edit. The right word count for a op ed signals that you understand the format and respect the reader\'s time.</p>
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>Word count expectations come from decades of convention. Publishers, editors, professors, and hiring managers all have a mental model for how long a op ed should be. Meeting that expectation is the baseline. Your content quality determines whether you exceed it.</p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Op Ed Writing Tips for 2026</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{color:'var(--text-primary)'}}>Digital Trends Affecting Op Ed Length</h2>
            ...
            <p className="leading-relaxed mb-3" style={{color:'var(--text-muted)'}}>AI tools have made it easy to generate long content quickly. This means the baseline for quality has risen. A op ed that reads like it was written by a template — generic phrasing, no specific details, predictable structure — will not stand out in 2026. Add original data, personal experience, or a specific point of view.</p>
